...
local Window = OrionLib:MakeWindow({Name = "NitroZ Hub | by mnghiaa",IntroText = "NitroZ Hub Library", HidePremium = false, SaveConfig = true, ConfigFolder = "AppleHub"})
...
local RE = Window:MakeTab({
	Name = "Race",
	Icon = "rbxassetid://4483345998",
	PremiumOnly = false
})
local SS = Window:MakeTab({
	Name = "Status And Sever",
	Icon = "rbxassetid://4483345998",
	PremiumOnly = false
})
local IS = Window:MakeTab({
	Name = "Items",
	Icon = "rbxassetid://4483345998",
	PremiumOnly = false
})
...
_G.SelectSpeedAttack = "0.15"

SF:AddDropdown({
    Name = "Select Speed Attack",
    Default = true,
    Options = SpeedAttackList,
    Flag = "SelectSpeedAttack",
    Save = false,
    Callback = function(Value)
        _G.SelectSpeedAttack = Value
    end
})
